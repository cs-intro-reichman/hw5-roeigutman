public class Wordle {
    ...
    public static String chooseSecretWord(String[] dict) {
       ...
       int randomword = (int) (Math.random() * dict.length);
    ...
    public static void main(String[] args) {
        ...
        while (attempt < MAX_ATTEMPTS && !won) {
           ...
           char [] Currentresult = new char[WORD_LENGTH];
           computeFeedback(secret, guess, Currentresult);

           results[attempt] = Currentresult;
